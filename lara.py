...
def get_system_info():
		...
		user_info = os.environ.get("USER", "Unknown User")
...
if __name__ == '__main__':
		init(autoreset=True)  # Assurez-vous que les couleurs sont réinitialisées après chaque utilisation
